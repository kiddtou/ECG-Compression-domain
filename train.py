...
def baseline_model():
    ...
    z1 = layers.Conv1D(16, 3, activation='tanh',padding='same')(z)
    z1 = layers.MaxPooling1D(2)(z1)
    z1 = layers.Conv1D(16, 3, activation='tanh', padding='same')(z1)
    z1 = layers.MaxPooling1D(2)(z1)
    z1 = layers.Conv1D(16, 3, activation='tanh', padding='same')(z1)
    z1 = layers.MaxPooling1D(5)(z1)
    z1 = layers.Flatten()(z1)
    z1 = layers.Dense(13)(z1)

    x = layers.Reshape((13, 1))(z1)
...
def plot_confusion_matrix(cm, classes, title='Confusion matrix', cmap=plt.cm.jet):
    ...
    plt.xticks(tick_marks, ('N', 'V', 'S', 'F'))
    plt.yticks(tick_marks, ('N', 'V', 'S', 'F'))
    thresh = cm.max() / 2.
...
loaded_model.compile(loss='categorical_crossentropy', optimizer='adam', metrics=['accuracy', km.f1_score(), km.binary_precision(), km.binary_recall()])
# 分类准确率
